...
class News(models.Model):
    name = models.CharField("Наза статті", max_length=100)

    short_description = models.CharField("Короткий опис", max_length=70, default="")

    infoFrom = models.CharField("Звідки взято інформацію / Хто написав", max_length=160, default="")
    isGiven = models.BooleanField("Чи взята де інде стаття", default=False)
